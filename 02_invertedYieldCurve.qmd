...
Data was scraped from [US Treasury's Resource Center](https://home.treasury.gov/resource-center/data-chart-center/interest-rates/TextView?type=daily_treasury_yield_curve&field_tdr_date_value=2024) using BeautifulSoup and Requests, see [previous analysis](01_webScraper.qmd) for the full ETL code.
...
### What's Next?
See the next analysis to understand what Principal Component Analysis (PCA) is and which maturities drive the overall trend. ([US Treasury Bond PCA](03_PCA.qmd))